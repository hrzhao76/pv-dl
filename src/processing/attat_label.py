...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input-root-path", help="the input folder path for MC", type=str, default=root_path
    )
    parser.add_argument(
        "--input-preds-folder", help="the input folder path Data", type=str, default=preds_folder
    )
    parser.add_argument(
        "--output-path", help="the output folder path", type=str, default=Path(root_path).parent.as_posix()
    )
